...
trait AdminTables {
  ...
  lazy val schema: profile.SchemaDescription = Array (GreatBareDependants.schema, GreatBareDependantsHistory.schema, GreatBareRights.schema, GreatBusinessUnits.schema, GreatDivision.schema, GreatDivisioncodeInSector.schema, GreatDivisionLimits.schema, GreatDivisionReportRight.schema, GreatDivisionUser.schema, GreatDownloadColumn.schema, GreatDownloadFormat.schema, GreatDownloadFormatRef.schema, GreatGroupStructure.schema, GreatGroupStructureHistory.schema, GreatPerson.schema, GreatUser.schema, GreatUserAccount.schema, GreatUserDeputies.schema, GreatUserGroup.schema, GreatUserInDivision.schema).reduceLeft(_ ++ _)
